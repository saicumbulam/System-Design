...
- [Transactions](#transactions)
  - [Transactions](#transactions-1)
    ...
    - [Single-Object and Multi-Object Operations](#single-object-and-multi-object-operations)
      ...
      - [Issues with multi-object transactions](#issues-with-multi-object-transactions)
  ...
  - [Weak Isolation Levels](#weak-isolation-levels)
      ...
      - [Why serial isolation cannot be used to handle concurrency issues](#why-serial-isolation-cannot-be-used-to-handle-concurrency-issues)
    - [Read Committed](#read-committed)
        - [Dirty Reads](#dirty-reads)
        - [Dirty Writes](#dirty-writes)
        - [Suitation this level cannot be used](#suitation-this-level-cannot-be-used)
        - [Implementing read committed](#implementing-read-committed)
        - [Snapshot Isolation and Repeatable Read](#snapshot-isolation-and-repeatable-read)
      - [Solve Read Skew Errors](#solve-read-skew-errors)
  ...
  - [Serializability](#serializability)
    ...
    - [Two-Phase Locking (2PL)](#two-phase-locking-2pl)
      ...
      - [Two-phase origin](#two-phase-origin)
...
#### Why serial isolation cannot be used to handle concurrency issues
...
*A core principle of snapshot isolation is this: Readers never block writers, and writers never block readers.*
...
the lost update problem. Basically, if two writes concurrently update a value, what's going to happen?
...
One alternative is to allow concurrent cycles to execute in parallel and let the transaction manager detect a lost update.
